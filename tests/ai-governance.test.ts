...
import { scoreEvaluation,validateEvalCase,validateUseCase } from "../app/ai/governance";
...
test("provider chain fails over once and records both health outcomes",async()=>{
  ...
  const base={provider:"openai-compatible" as const,model:"model",apiKey:"",temperature:0.2,timeoutMs:5000,maxTokens:128};
