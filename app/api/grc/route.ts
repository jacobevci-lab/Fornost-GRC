...
const seeds:[string,ModuleName,Data][]=[
 ["RSK-001","Risk Assessment",{title:"Ayrıcalıklı hesapların kötüye kullanılması",businessUnit:"Bilgi Teknolojileri",owner:"Bilgi Güvenliği",asset:"Microsoft Entra ID",inherentLikelihood:4,inherentImpact:5,treatment:"Azalt",status:"Açık",nextReview:"2026-12-31"}],
 ["BIA-001","BIA",{process:"E-Ticaret Sipariş Yönetimi",businessUnit:"Dijital Kanallar",owner:"E-Ticaret",criticality:"Kritik",rto:2,rpo:1,financial:5,operational:5,legal:3,reputation:4,asset:"E-Ticaret Platformu"}],
 ["AST-001","Varlık Envanteri",{title:"Microsoft Entra ID",assetType:"Bulut Servisi",businessUnit:"Bilgi Teknolojileri",owner:"IT Altyapı",criticality:"Kritik",environment:"Üretim",location:"Azure",ip:"entra.microsoft.com",status:"Aktif"}],
 ["CMP-001","Uyum",{framework:"ISO/IEC 27001:2022",controlRef:"A.5.15",controlTitle:"Erişim kontrolü",owner:"Bilgi Güvenliği",implementation:"Uygulanıyor",status:"Uyumlu"}],
 ["VEN-001","Tedarikçiler",{title:"Bordro SaaS",service:"Bordro yönetimi",owner:"İK",criticality:"Yüksek",riskLevel:"Orta",status:"Aktif"}],
 ["CTL-001","Kontroller",{controlRef:"CTL-001",controlTitle:"Ayrıcalıklı hesaplarda güçlü MFA",owner:"IAM Ekibi",frequency:"Sürekli",status:"Uygulanıyor"}],
 ["AUD-001","Denetim Yönetimi",{auditName:"ISO 27001:2022 Gözetim Denetimi",auditType:"Dış Denetim",auditor:"Bağımsız Denetim Kuruluşu",auditOwner:"Bilgi Güvenliği",startDate:"2026-09-14",endDate:"2026-09-18",requirementRef:"A.5.15",requirementTitle:"Erişim kontrolü uygulamalarının doğrulanması",owner:"IAM Ekibi",businessUnit:"Bilgi Teknolojileri",dueDate:"2026-09-04",status:"Devam Ediyor",progress:60,evidenceStatus:"Kanıt Bekleniyor",controlRef:"CTL-001",riskRef:"RSK-001"}]
];
