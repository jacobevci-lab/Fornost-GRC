...
test("transport failures create governance-only signals and cannot recursively email themselves",()=>{
 const policy={criticalSlaMinutes:60,highSlaMinutes:240,mediumSlaMinutes:1440,maxAttempts:2},now=new Date("2026-09-21T20:00:00.000Z"),outbox=[{id:"O-1",escalation_id:"E-1",recipient:"owner@example.com",severity:"critical",status:"queued",subject:"Critical assurance issue",created_at:"2026-09-21T17:00:00.000Z"}],deliveries=[{id:"D-1",outbox_id:"O-1",attempt:1,provider:"email-api",state:"failed" as const,detail:"HTTP 500",recipient:"owner@example.com",attempted_by:"system",attempted_at:"2026-09-21T18:00:00.000Z"},{id:"D-2",outbox_id:"O-1",attempt:2,provider:"email-api",state:"failed" as const,detail:"HTTP 500",recipient:"owner@example.com",attempted_by:"system",attempted_at:"2026-09-21T19:00:00.000Z"}];
