...
export default function ExecutiveAssurancePanel({rows,lang,go}:{rows:AssuranceRow[];lang:"tr"|"en";go:(module:string)=>void}){
 const tr=lang==="tr",assurance=buildExecutiveAssurance(rows),[operations,setOperations]=useState<Operations|null>(null),[delivery,setDelivery]=useState<DeliveryOps|null>(null),[detailsOpen,setDetailsOpen]=useState(false);
