...
export default function FornostAiCopilot() {
  ...
  const [tab, setTab] = useState<"chat" | "agents" | "knowledge" | "drafts" | "metrics" | "governance" | "feedback" | "settings" | "audit">("chat");
  ...
  const activeTab = user.role !== "Admin" && (tab === "settings" || tab === "audit" || tab === "metrics" || tab === "governance" || tab === "feedback") ? "chat" : tab;
