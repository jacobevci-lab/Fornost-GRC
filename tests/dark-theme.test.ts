...
test("genuine dark mode uses charcoal surfaces and accessible indigo interaction",()=>{
  for(const token of ["--atlas-surface:#121b28","--atlas-text:#edf2f8","--atlas-brand:#a79cff","--atlas-sidebar:#0c0d12"])assert.match(theme,new RegExp(token));
