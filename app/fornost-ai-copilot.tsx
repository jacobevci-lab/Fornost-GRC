...
import FornostAiAssuranceAlerts from "./fornost-ai-assurance-alerts";
  ...
  return <>
    ...
    {open && <section id="fornost-ai-panel" className="fornost-ai-panel" aria-label="Fornost AI Copilot">
      ...
      <nav className="fornost-ai-tabs">
        ...
        {user.role === "Admin" && <button className={activeTab === "assurance-alerts" ? "active" : ""} onClick={() => setTab("assurance-alerts")}>AI Alarmlar</button>}
