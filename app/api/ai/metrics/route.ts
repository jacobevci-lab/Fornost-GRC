...
export async function GET(req:NextRequest){
  ...
  const [activity,drafts,published,tickets,daily,models,errors,governance,evaluations,failover]=await Promise.all([
